...
Player.where( id: 1, name: 'David Taylor', email: 'david.taylor5@hp.com', active: true, points: (30+60+75) ).first_or_create
Player.where( id: 2, name: 'Nil Camacho', email: 'nil.camacho.ramonet@hp.com', active: true, points: (25+40+54) ).first_or_create
Player.where( id: 3, name: 'Ruben Infante', email: 'ruben.infante@hp.com', active: true, points: (20+36+48) ).first_or_create
Player.where( id: 4, name: 'Ryan Schreiber', email: 'ryan.schreiber@hp.com', active: true, points: (16+36+30) ).first_or_create
Player.where( id: 5, name: 'Riley Dasch', email: 'riley.dasch@hp.com', active: true, points: (16+36+36) ).first_or_create
Player.where( id: 6, name: 'Sandeep Venkata', email: 'sandeep.venkata@hp.com', active: true, points: (0+50+60) ).first_or_create
Player.where( id: 7, name: 'Noah Collins', email: 'noah.collins@hp.com', active: true, points: (18+32+18) ).first_or_create
Player.where( id: 8, name: 'Daniel De La Garza', email: 'Daniel.de.la.garza@hp.com', active: true, points: (12+32+42) ).first_or_create
Player.where( id: 9, name: 'Erick Romero', email: 'erick.romero@hp.com', active: true, points: (14+32+24) ).first_or_create
Player.where( id: 10, name: 'Paul Min', email: 'paul.min@hp.com', active: false, points: (0+40+0) ).first_or_create
Player.where( id: 11, name: 'Isaac Chan', email: 'isaac.chan1@hp.com', active: true, points: (14+32+36) ).first_or_create
Player.where( id: 12, name: 'David "Thor" Hagan', email: 'david.m.hagan@hp.com', active: true, points: (12+40+30) ).first_or_create
Player.where( id: 13, name: 'Sheena Chen', email: 'sheena@hp.com', active: true, points: (10+32+36) ).first_or_create
Player.where( id: 14, name: 'Bryce Tucker', email: 'bryce.tucker@hp.com', active: true, points: (10+28+24) ).first_or_create
Player.where( id: 15, name: 'Ernest Sliter', email: 'ernest.sliter@hp.com', active: false, points: (8+34+18) ).first_or_create
Player.where( id: 16, name: 'Luke Bockman', email: 'luke.bockman1@hp.com', active: true, points: (10+28+24) ).first_or_create
Player.where( id: 17, name: 'Chris Timbreza', email: 'chris.timbreza@hp.com', active: true, points: (0+36+24) ).first_or_create
Player.where( id: 18, name: 'Marwan elGendy', email: 'Marwan.elgendy@hp.com', active: true, points: (10+20+24) ).first_or_create
Player.where( id: 19, name: 'Arpan Chakraborty', email: 'arpan.chakraborty@hp.com', active: true, points: (12+20+48) ).first_or_create
Player.where( id: 20, name: 'Bryan Ginger', email: 'bryan.goss@hp.com', active: true, points: (8+20+24) ).first_or_create
Player.where( id: 21, name: 'Nicholas Staub', email: 'Nicholas.staub@hp.com', active: true, points: (8+20+18) ).first_or_create
Player.where( id: 22, name: 'Petar Obradovic', email: 'petar.obradovic@hp.com', active: false, points: (8+12+0) ).first_or_create
Player.where( id: 23, name: 'Jake Sahli', email: 'jake.sahli@hp.com', active: true, points: (0+0+18) ).first_or_create
Player.where( id: 24, name: 'Rowdy Webb', email: 'rowdy@hp.com', active: true, points: (0+0+42) ).first_or_create
Player.where( id: 25, name: 'Vlad Shapoval', email: 'vladislav.shapoval@hp.com', active: true, points: (0+0+54) ).first_or_create
Player.where( id: 26, name: 'Devin Uehling', email: 'devin.uehling@hp.com', active: true, points: (0+0+18) ).first_or_create
Player.where( id: 27, name: 'Nate Martin', email: 'nate@hp.com', active: true, points: (0+0+24) ).first_or_create
Player.where( id: 28, name: 'Wayne Lian', email: 'wen-yu.lian@hp.com', active: true, points: (0+0+30) ).first_or_create
Player.where( id: 29, name: 'Bonny James', email: 'boniface.jam.mbuya@hp.com', active: true, points: (0+0+30) ).first_or_create
Player.where( id: 30, name: 'Paul Osborne', email: 'paul.all.osborne@hp.com', active: true, points: (0+0+36) ).first_or_create
Player.where( id: 31, name: 'Dina Sampath', email: 'dinakaran@hp.com', active: true, points: (0+0+24) ).first_or_create
Player.where( id: 32, name: 'Shane Zhao', email: 'UNAVAILABLE', active: false, points: (0+0) ).first_or_create
...
m = Match.where( id: 1, player_1_id: 15, player_2_id: 22, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 2, player_1_id: 14, player_2_id: 21, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 3, player_1_id: 18, player_2_id: 2, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 4, player_1_id: 1, player_2_id: 15, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 5, player_1_id: 11, player_2_id: 12, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 6, player_1_id: 5, player_2_id: 32, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 7, player_1_id: 3, player_2_id: 16, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 8, player_1_id: 7, player_2_id: 14, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 9, player_1_id: 4, player_2_id: 19, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 10, player_1_id: 13, player_2_id: 9, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 11, player_1_id: 8, player_2_id: 2, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 12, player_1_id: 8, player_2_id: 22, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 13, player_1_id: 16, player_2_id: 21, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 14, player_1_id: 18, player_2_id: 15, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 15, player_1_id: 8, player_2_id: 13, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 16, player_1_id: 19, player_2_id: 14, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 17, player_1_id: 16, player_2_id: 32, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 18, player_1_id: 12, player_2_id: 18, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 19, player_1_id: 1, player_2_id: 11, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 20, player_1_id: 5, player_2_id: 3, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 21, player_1_id: 7, player_2_id: 4, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 22, player_1_id: 9, player_2_id: 2, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 23, player_1_id: 5, player_2_id: 8, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 24, player_1_id: 11, player_2_id: 19, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 25, player_1_id: 9, player_2_id: 32, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 26, player_1_id: 4, player_2_id: 12, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 27, player_1_id: 5, player_2_id: 11, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 28, player_1_id: 9, player_2_id: 4, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 29, player_1_id: 1, player_2_id: 3, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 30, player_1_id: 7, player_2_id: 2, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 31, player_1_id: 3, player_2_id: 5, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 32, player_1_id: 7, player_2_id: 4, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 33, player_1_id: 3, player_2_id: 7, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 34, player_1_id: 1, player_2_id: 2, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 35, player_1_id: 2, player_2_id: 3, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 36, player_1_id: 1, player_2_id: 2, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 37, player_1_id: 1, player_2_id: 2, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
...
m = Match.where( id: 38, player_1_id: 20, player_2_id: 14, format: Match::B321, weight: 0, tournament_id: 1 ).first_or_create
Game.where( id: 86, winner: 14, loser: 20, match_id: m.id ).first_or_create
#---------------------------------------------------------------------------------------------------------------#
